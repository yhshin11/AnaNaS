...
N=`rfdir /castor/cern.ch/user/m/mmarionn/Ntuples/v3/$2 2>&1 | grep directory`

if [ -z "$N" ]; then
rfmkdir /castor/cern.ch/user/m/mmarionn/Ntuples/v3/$2
fi


rfcp $path/$4/$3.root /castor/cern.ch/user/m/mmarionn/Ntuples/v3/$2/AnaTuple_$3
